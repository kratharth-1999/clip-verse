...
const LiveChat = () => {
    ...
    return (
        <div className="border border-gray-300 rounded w-full mb-8 bg-slate-50 px-4 py-2 overflow-y-auto lg:h-[410px] xl:h-[530px] 2xl:h-[850px] flex flex-col-reverse">
            <form
